...
This document contains three specialized research prompts designed to generate comprehensive, technically deep insights for creating implementation skills. Each prompt follows a Layered Research Framework that progresses systematically from theoretical foundations to practical implementation opportunities.

## Target Use Case

- **Domain**: Software Engineering
- **Depth Level**: Expert/Research Level
- **Skill Type**: Implementation Skills
- **Research Style**: Dense, deep, and comprehensive

---

## Research Prompt 1: Technology Stack Deep Dive
...
- **Key Contributors**: Map influential researchers, engineers, organizations, and seminal papers
...
- **Tooling Ecosystem**: Evaluate development tools, debugging capabilities, build systems, and deployment pipelines
...
- **Integration Challenges**: Analyze interoperability issues with other technologies and platforms
...
- **Developer Experience**: Create innovations in debugging, testing, deployment, and workflow automation
- **Ecosystem Expansion**: Develop libraries, frameworks, and integrations that extend the stack's capabilities

---

## Research Prompt 2: Problem Domain Deep Dive
...
- **Domain Invariants**: Identify core principles, constraints, and immutable characteristics
...
- **Operational Patterns**: Study real-world deployment patterns and operational characteristics
...
- **Failure Modes**: Study common failure scenarios, edge cases, and recovery strategies
...
- **Automation Frameworks**: Develop intelligent automation for complex or repetitive tasks
- **Educational Resources**: Build learning tools and knowledge transfer mechanisms

---

## Research Prompt 3: Methodology/Pattern Deep Dive
...
- **Seminal Works**: Identify influential papers, books, and research contributions
...
- **Failure Analysis**: Study common failures, anti-patterns, and lessons learned
...
- **Integration Conflicts**: Study incompatibilities with other methodologies and practices
...
- **Technology Integration**: Explore how new tools and platforms are changing the methodology
...
- **Learning Platforms**: Create educational resources, interactive tutorials, and skill assessment tools
- **Metric Systems**: Design comprehensive measurement and analysis frameworks

---

## Individual Research Prompt Templates

### Available Templates

1. **[Technology Stack Deep Dive](../research/technology-stack-deep-dive-prompt.md)**
   - Focus: Specific technologies, frameworks, or platforms
   - Use Case: Creating skills around particular tech stacks
   - Template File: `docs/research/technology-stack-deep-dive-prompt.md`

2. **[Problem Domain Deep Dive](../research/problem-domain-deep-dive-prompt.md)**
   - Focus: Specific technical challenges and problem areas
   - Use Case: Addressing domain-specific technical challenges
   - Template File: `docs/research/problem-domain-deep-dive-prompt.md`

3. **[Methodology/Pattern Deep Dive](../research/methodology-pattern-deep-dive-prompt.md)**
   - Focus: Development practices, processes, and design approaches
   - Use Case: Improving development methodologies and patterns
   - Template File: `docs/research/methodology-pattern-deep-dive-prompt.md`
...
- **Output Requirements**: Guidelines for documenting findings
- **Next Steps**: Action items for moving from research to implementation

### How to Use the Templates

1. **Select Appropriate Template**: Choose based on your research focus
2. **Fill in Placeholders**: Replace `[INSERT...]` sections with your specific targets
3. **Follow Checklist**: Complete all items systematically
4. **Document Findings**: Use the provided output structure
5. **Generate Opportunities**: Identify concrete skill development projects
...
1. **Technology Stack Template**: Use when focusing on specific technologies, frameworks, or platforms
2. **Problem Domain Template**: Use when addressing specific technical challenges or problem areas
3. **Methodology/Pattern Template**: Use when improving development practices, processes, or design approaches

### Research Execution Best Practices

1. **Start Broad, Then Deep**: Begin with comprehensive surveys before diving into specific details
2. **Complete All Checklist Items**: Ensure systematic coverage of each layer
3. **Cross-Reference Multiple Sources**: Combine academic papers, industry reports, and practical experience
4. **Focus on Implementation**: Always connect research back to actionable skill opportunities
5. **Document Trade-Offs**: Capture not just benefits but also limitations and contexts
6. **Look for Intersections**: Pay attention to where different domains or approaches meet
...
These research prompt templates provide a structured framework for conducting expert-level research in software engineering. Each template is designed to:

1. **Guide Systematic Research**: Ensure comprehensive coverage of the research domain
2. **Identify High-Impact Opportunities**: Focus on areas where implementation skills can provide significant value
3. **Enable Actionable Insights**: Produce findings that can be directly translated into skill development projects
4. **Support Documentation**: Create clear records of research processes and outcomes

Use these templates to conduct deep, structured research that reveals opportunities for creating sophisticated implementation skills in software engineering.

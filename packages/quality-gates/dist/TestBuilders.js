...
export class TestBuilders {
     ...
     */
    createInvalidAgentRequest(invalidAgent) {
        return {
     ...
     */
    createPerformanceTestRequest(role) {
        return {
...
//# sourceMappingURL=TestBuilders.js.map
 ...
 */
export function getAgentTemplate(role: AgentRole): AgentTemplate | undefined {
 ...
 */
export function hasTemplate(role: AgentRole): boolean {
 ...
 */
export function getTemplateRoles(): AgentRole[] {
  return Object.keys(AGENT_TEMPLATES) as AgentRole[];
}

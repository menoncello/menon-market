 ...
 * QA Agent Template
 */
export const QATemplate: AgentTemplate = {
  id: 'qa-template',
  name: 'Quality Assurance Agent Template',
  description:
    'Customizable template for creating QA specialists with expertise in testing strategies and quality assurance',
  baseRole: 'QA',
  template: {
  ...
  customizationOptions: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'Expert in comprehensive testing strategies, test automation, and quality assurance processes.',
      required: true,
    },
    {
      id: 'backstory',
      ...
      type: 'string',
      defaultValue:
        'I am a dedicated quality assurance professional with expertise in both manual and automated testing methodologies.',
      required: true,
    },
  ],
  templateMetadata: {
...
export const ArchitectTemplate: AgentTemplate = {
  ...
  description:
    'Customizable template for creating system architects with expertise in technical design and strategic planning',
  baseRole: 'Architect',
  template: {
    name: '{{name}}', // Will be filled by TemplateEngine
    description: '{{description}}', // Will be filled by TemplateEngine
    ...
    learningMode: 'autonomous' as LearningMode,
    configuration: {
      performance: {
        maxExecutionTime: 45,
        memoryLimit: 512,
  ...
  customizationOptions: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'I am a seasoned system architect with extensive experience in designing large-scale distributed systems.',
      required: true,
    },
  ],
  templateMetadata: {
 ...
 */
export const CLIDevTemplate: AgentTemplate = {
  id: 'cli-dev-template',
  name: 'CLI Development Agent Template',
  description:
    'Customizable template for creating CLI development specialists with expertise in command-line tools and automation',
  baseRole: 'CLI Dev',
  template: {
    name: '{{name}}', // Will be filled by TemplateEngine
    description: '{{description}}', // Will be filled by TemplateEngine
  ...
  customizationOptions: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'Expert in command-line interface development, developer tooling, and automation scripts.',
      required: true,
    },
    {
      id: 'backstory',
      ...
      type: 'string',
      defaultValue:
        'I am a CLI development specialist with deep expertise in creating command-line tools that developers love to use.',
      required: true,
    },
  ],
  templateMetadata: {

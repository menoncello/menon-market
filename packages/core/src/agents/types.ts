...
export type AgentRole =
  ...
  | 'UX Expert'
  | 'SM'
  | 'Custom'; // For user-defined agent types
...
export type LearningMode =
  ...
  | 'static' // Uses predefined knowledge only
  | 'collaborative' // Learns from team interactions
...
export interface CreateAgentRequest {
  ...
  definition: AgentDefinition | string; // string for template ID

...
import { AgentTemplate, LearningMode, CommunicationStyle, ResponseFormat } from './types';

/**
 * Frontend Development Agent Template
 */
export const FrontendDevTemplate: AgentTemplate = {
  id: 'frontend-dev-template',
  name: 'Frontend Development Agent Template',
  description:
    'Customizable template for creating frontend development specialists with expertise in modern web technologies',
  ...
  template: {
    ...
    learningMode: 'adaptive' as LearningMode,
    configuration: {
      performance: {
        maxExecutionTime: 45,
        memoryLimit: 512,
      ...
      communication: {
        style: 'detailed' as CommunicationStyle,
  ...
  customizationOptions: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'Expert in modern frontend development, specializing in React, TypeScript, component architecture, and user interface implementation.',
      required: true,
      validation: [
        {
          type: 'min',
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'I am a senior frontend developer with extensive experience in modern JavaScript frameworks and component-based architectures.',
      required: true,
    },
    {
      id: 'maxExecutionTime',
      ...
      validation: [
        {
          ...
          message:
            'Communication style must be one of: formal, casual, technical, educational, concise, detailed',
        },
      ],
    },
  ],
 ...
 */
export const BackendDevTemplate: AgentTemplate = {
  id: 'backend-dev-template',
  name: 'Backend Development Agent Template',
  description:
    'Customizable template for creating backend development specialists with expertise in server-side technologies and architecture',
  baseRole: 'BackendDev',
  template: {
    name: '{{name}}', // Will be filled by TemplateEngine
    description: '{{description}}', // Will be filled by TemplateEngine
  ...
  customizationOptions: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue:
        'Expert in server-side development, API design, database architecture, and system integration.',
      required: true,
    },
    {
      id: 'backstory',
      ...
      type: 'string',
      defaultValue:
        'I am a seasoned backend developer with deep expertise in distributed systems, API design, and database optimization.',
      required: true,
    },
    {
      id: 'maxExecutionTime',

 ...
 */
export const UXExpertTemplate = {
    id: 'ux-expert-template',
    name: 'UX Design Agent Template',
    description: 'Customizable template for creating UX design specialists with expertise in user experience and usability',
    baseRole: 'UX Expert',
    template: {
    ...
    customizationOptions: [
        ...
        },
        {
            ...
            type: 'string',
            defaultValue: 'Expert in user experience design, usability research, and user-centered design principles.',
            required: true,
        },
        {
            id: 'backstory',
            ...
            type: 'string',
            defaultValue: 'I am a UX design specialist with extensive experience in user research, interaction design, and usability testing.',
            required: true,
        },
    ],
    templateMetadata: {
...
export const SMTemplate = {
    ...
    description: 'Customizable template for creating Scrum Master agents with expertise in agile methodologies and team facilitation',
    baseRole: 'SM',
    template: {
        name: '{{name}}', // Will be filled by TemplateEngine
        description: '{{description}}', // Will be filled by TemplateEngine
    ...
    customizationOptions: [
        ...
        },
        {
            ...
            type: 'string',
            defaultValue: 'I am an experienced Scrum Master and Agile Coach with a passion for helping teams achieve their full potential.',
            required: true,
        },
    ],
    templateMetadata: {
...
//# sourceMappingURL=template-definitions-part3.js.map
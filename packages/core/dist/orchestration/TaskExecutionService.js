...
export class TaskExecutionService {
     ...
     * @param _metadata
     */
    async executeTask(agent, request, _metadata) {
        ...
        const collaborationUsed = agent.configuration.communication.collaboration.enabled && Math.random() > 0.7;
     ...
     * @param toolsUsed
     */
    calculateConfidence(agent, task, toolsUsed) {
        ...
        const toolsScore = (toolsUsed.length / agent.configuration.capabilities.allowedTools.length) * 10;
...
//# sourceMappingURL=TaskExecutionService.js.map
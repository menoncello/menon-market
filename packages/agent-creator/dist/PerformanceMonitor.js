...
export class PerformanceMonitor {
    ...
    isPerformanceHealthy() {
        return (this.metrics.averageCreationTime < 30000 && // 30 seconds
     ...
     */
    getAgentTypePerformance() {
        const agentTypeMetrics = {};
        // Group by agent type

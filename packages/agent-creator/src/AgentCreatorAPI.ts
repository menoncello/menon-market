...
export class AgentCreatorAPI {
  ...
  async getPredefinedAgent(req: Request, res: Response): Promise<void> {
    try {
      ...
      const agent = this.agentCreationService.getPredefinedAgent(role as AgentRole);
  ...
  async getTemplate(req: Request, res: Response): Promise<void> {
    try {
      ...
      const template = this.agentCreationService.getTemplate(role as AgentRole);
  ...
  async validateTemplateCustomizations(req: Request, res: Response): Promise<void> {
    try {
      ...
      const validation = this.agentCreationService.validateTemplateCustomizations(
        role,
        customizations
      );

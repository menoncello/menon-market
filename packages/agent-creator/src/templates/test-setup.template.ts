...
function generateTestImports(): string {
  return `/**
...
function generateTestHooks(): string {
...
function generateMockAgent(): string {
  return `/**
...
function generateTempDirUtils(): string {
  return `/**
...
function generateTestUtils(): string {
...
function generateAgentValidator(): string {

...
function generateMcpServerImports(): string {
  return `/**
...
function generateMcpServerCreateFunction(): string {
  return `/**
...
function generateMcpServerToolHandler(): string {
...
function generateMcpServerEventHandlers(): string {
...
function generateMcpServerStartFunction(): string {
  return `/**
...
function generateMcpServerEntry(): string {
...
export function generateMcpServerTemplate(): string {
  return [

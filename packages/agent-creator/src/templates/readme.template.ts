...
function generateReadmeHeader(): string {
  return `# {{agentType}}
...
function generateReadmeInstallation(): string {
  return `## Installation
...
function generateReadmeUsage(): string {
  return `## Usage
...
function generateReadmeMcpSection(): string {
...
function generateReadmeConfiguration(): string {
...
function generateReadmeProjectStructure(): string {
...
function generateReadmeDevelopment(): string {
  return `## Development
...
function generateReadmeFooter(): string {
  return `## Contributing
...
export function generateReadmeTemplate(): string {
  return [
